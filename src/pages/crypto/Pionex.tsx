      ...
      <div className="container mx-auto pt-8 pl-5 pr-5 transition-colors duration-100">
        ...
        <form>
          ...
          <div className="grid md:grid-cols-3 md:gap-6">       
            {/* 持倉均價 */}
            <div className="relative z-0 w-full mb-6 group">
                <input type="text" name="position_price"  id="position_price" onChange={ (event) => handleTextChange('position_price', event)} className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="" required />
